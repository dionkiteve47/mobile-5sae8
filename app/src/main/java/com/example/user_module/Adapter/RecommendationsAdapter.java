...
import com.example.user_module.activity.AccommodationDetailActivity;
...
public class RecommendationsAdapter extends RecyclerView.Adapter<RecommendationsAdapter.RecommendationViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecommendationViewHolder holder, int position) {
        ...
        holder.viewOfferButton.setOnClickListener(v -> {
            ...
            intent.putExtra("location", accommodation.getLocation()); // Pass the location
            intent.putExtra("type", accommodation.getType()); // Pass the type
            intent.putExtra("capacity", accommodation.getCapacity()); // Pass the capacity
            intent.putExtra("isAvailable", accommodation.isAvailable()); // Pass availability
            intent.putExtra("title", accommodation.getTitle()); // Pass the title
            intent.putExtra("pricePerNight", accommodation.getPricePerNight());
